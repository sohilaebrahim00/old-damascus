...
export const MENU_IMAGE_MAP: Record<string, string | ImageMapping> = {
  ...
  "adana kabob plate": shot("kofta-kabab-plate", "beef-kebab-skewers"),
  "adana-kabob-plate": shot("kofta-kabab-plate", "beef-kebab-skewers"),
  ...
  "arayes plate 2 pcs": shot("arayes"),
  "arayes-plate-2-pcs": shot("arayes"),
  arayes: shot("arayes"),
  "item-stuffed-grilled-pita": shot("arayes"),
  ...
  "item-shish-tawook-wrap": shot("shish-tawook-sandwich", "shish-tawook-skewers"),
  "shish-tawook-wrap": shot("shish-tawook-sandwich", "shish-tawook-skewers"),
  "shish tawook sandwich": shot("shish-tawook-sandwich", "shish-tawook-skewers"),
  "shish-tawook-sandwich": shot("shish-tawook-sandwich", "shish-tawook-skewers"),
  "item-beef-kabob-sandwich": shot("kofta-kabab-sandwich"),
  "beef-kabob-sandwich": shot("kofta-kabab-sandwich"),
  "beef kabab sandwich": shot("kofta-kabab-sandwich"),
  "item-adana-kebab-sandwich": shot("kofta-kabab-sandwich", "beef-kebab-skewers"),
  "adana-kebab-sandwich": shot("kofta-kabab-sandwich", "beef-kebab-skewers"),
  "adana kabob sandwich": shot("kofta-kabab-sandwich", "beef-kebab-skewers"),
  "adana-kabob-sandwich": shot("kofta-kabab-sandwich", "beef-kebab-skewers"),
  "kofta kabab sandwich": shot("kofta-kabab-sandwich"),
  "kofta-kabab-sandwich": shot("kofta-kabab-sandwich"),
  ...
  // ── Drinks ──────────────────────────────────────────────────
  "fresh lemonade": shot("lemon-mint"),
  "fresh-lemonade": shot("lemon-mint"),
  "lemon-mint": shot("fresh-juices"),
  "lemon mint": shot("fresh-juices"),
  ...
  vimto: shot("vimto"),
  laziza: shot("laziza"),
  "yougrt drink": shot("ayran"),
  "yougrt-drink": shot("ayran"),
  ayran: shot("ayran"),
  water: shot("water"),
  "sparkling water": shot("sparkling-water"),
  "sparkling-water": shot("sparkling-water"),
  perrier: shot("sparkling-water"),
